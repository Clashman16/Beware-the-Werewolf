        ...
        private GameObject GetHayRollStack(GridCellBehaviour p_cell)
        {
            ...
            switch (l_dHayRollStackCount)
            {
                case 1:
                    ...
                    l_vecPosition = new Vector3(0, 0, 0.2773333f);

                    l_vecRotation = Vector3.zero;

                    l_vecLocalScale = Vector3.one;
                ...
                default:
                    ...
                    l_vecPosition = new Vector3(0, -0.75f, 0);

                    l_vecRotation = Vector3.zero;

                    l_vecLocalScale = new Vector3(4, 4, 0.15f);
            ...
            l_trfStack.localScale = l_vecLocalScale;
